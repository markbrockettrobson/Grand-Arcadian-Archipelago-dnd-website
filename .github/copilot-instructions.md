...
This repository is an **Obsidian vault** for tracking a home tabletop RPG campaign called **"The Arcadian Archipelago"**.

**System:** Pathfinder 2nd Edition (PF2e)  
**Campaign Type:** Island exploration, ancient mysteries, pirate adventure  
**Format:** Obsidian markdown notes with wiki-style linking
...
- XP and encounter building follows PF2e guidelines
...
- Follow the existing linking structure
...
**CRITICAL: Player Knowledge Perspective**
...
- Theories and speculation (clearly marked as such, e.g., "Many suspect...", "It appears that...")
...
- Definitive statements about unknowable truths
- GM-only strategic information

**Instead of:** "The Chelish joined to control the flotilla."  
**Write:** "Many suspect the Chelish joined to assert control over the flotilla's decisions."

**Instead of:** "Lord Voss secretly resents the delays he created."  
...
- Link session notes to all relevant entities
- Use relative paths for links within the vault
...
- Follow existing templates and formats
...
- Create content without proper linking
...
- Campaign has an island exploration theme
- Ancient Arcadian civilization is a central mystery
- Expect nautical/pirate elements
- Tropical setting with jungles and ruins
